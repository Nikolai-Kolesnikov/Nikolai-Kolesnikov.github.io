...
document.getElementById("verh").innerHTML = "dynamic 27<br>";
...
.then((response) => {
    document.getElementById("verh").innerHTML += 'получен response: ';
    document.getElementById("verh").innerHTML += response;
