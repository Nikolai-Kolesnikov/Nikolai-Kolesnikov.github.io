...
document.getElementById("verh").innerHTML = "dynamic 28<br>";
...
.then((response) => {
    document.getElementById("verh").innerHTML += 'получен response. response.json() = ';
    document.getElementById("verh").innerHTML += JSON.stringify(response.json());
